...
const JobDescription = () => {
    ...
    // useEffect(() => {
    //     if (user && singleJob) {
    //         console.log("Applications Array:", singleJob?.applications); // Log the applications array
    
    //         // Checking the condition
    //         const hasApplied = singleJob?.applications?.some(application => {
    //             console.log("Applicantion object:", application); // Log each applicant ID
    //             return application.applicant === user?._id;
    //         });
    
    //         console.log("Has Applied:", hasApplied); // Log the result of the check
    //     }
    // }, [singleJob, user]);
    ...
    return (
        <div className='max-w-7xl mx-auto my-10'>
            ...
            <div className='my-4'>
                ...
                {/* <p>{console.log(singleJob?.createdAt)}</p> */}
            </div>
        </div>
    )
}
